...
exports.State = exports.StateCredentials = void 0;
...
__decorate([
    (0, sequelize_typescript_1.ForeignKey)(() => StateCredentials),
    (0, sequelize_typescript_1.Column)({
        type: sequelize_typescript_1.DataType.INTEGER,
    }),
    __metadata("design:type", Number)
...
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => StateCredentials),
    __metadata("design:type", StateCredentials)
], State.prototype, "stateCredentials", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({
        type: sequelize_typescript_1.DataType.STRING,
    }),
...
__decorate([
    ...
    __metadata("design:type", Number)
], State.prototype, "betSum", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({
        type: sequelize_typescript_1.DataType.INTEGER,
    }),
    __metadata("design:type", Number)
], State.prototype, "stackSize", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({
        type: sequelize_typescript_1.DataType.INTEGER,
    }),
    __metadata("design:type", Number)
], State.prototype, "stackFilled", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({
        type: sequelize_typescript_1.DataType.FLOAT,
    }),
...
State = __decorate([
    (0, sequelize_typescript_1.Table)({ tableName: "state" })
], State);
exports.State = State;
